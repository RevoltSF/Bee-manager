...
module.exports = class BotClient extends Client {
  shiftdatabase = new QuickYAML("./shifts.yaml");
  taskdatabase = new QuickYAML("./tasks.yaml");
  reportdatabase = new QuickYAML("./reports.yaml");
  ticketdatabase = new QuickYAML("./ids.yaml");
  threadsdatabase = new QuickYAML("./threads.yaml");
  eventdatabase = new QuickYAML("./events.yaml");
  todolistdatabase = new QuickYAML("./todo.yaml");
  catererdatabase = new QuickYAML("./caterer.yaml");
  partnerdatabase = new QuickYAML("./partner.yaml");
  constructor() {
    super({
      intents: [
